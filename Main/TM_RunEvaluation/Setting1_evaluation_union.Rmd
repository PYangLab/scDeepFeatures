...
while(j<=10){
  ...
  for (method in nn_methods){
    ...
    for (topN in c(5, 10, 20)) { #5, 10, 20, 50, 100
      ...
      print("Accuracy is:")
      print(res[[1]][,1][1])
      dir.create(glue("../../Result/Classification/KKnn/Setting1/top{topN}"), showWarnings = FALSE)
      dir.create(glue("../../Result/Classification/KKnn/Setting1/top{topN}/{method}"), showWarnings = FALSE)
      dir.create(glue("../../Result/Classification/KKnn/Setting1/top{topN}/{method}/dataset_seeds_{n}"), showWarnings = FALSE)
      saveRDS(res, file = glue("../../Result/Classification/KKnn/Setting1/top{topN}/{method}/dataset_seeds_{n}/KKnn_top{topN}_result_nGroups_{nGroups}_iteration{j}_seeds{n}_method_{method}.rds"))
      }
  }
...
while(j<=10){
  ...
  for (method in nn_methods){
    ...
    for (topN in c(5, 10, 20)) { #5, 10, 20, 50, 100
      ...
      print("Accuracy is:")
      print(res[[1]][,1][1])
      dir.create(glue("../../Result/Classification/SVM/Setting1/top{topN}"), showWarnings = FALSE)
      dir.create(glue("../../Result/Classification/SVM/Setting1/top{topN}/{method}"), showWarnings = FALSE)
      dir.create(glue("../../Result/Classification/SVM/Setting1/top{topN}/{method}/dataset_seeds_{n}"), showWarnings = FALSE)
      saveRDS(res, file = glue("../../Result/Classification/SVM/Setting1/top{topN}/{method}/dataset_seeds_{n}/KKnn_top{topN}_result_nGroups_{nGroups}_iteration{j}_seeds{n}_method_{method}.rds"))
      }
