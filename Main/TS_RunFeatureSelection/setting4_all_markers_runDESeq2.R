...
while(j<=10){
  ...
  sce = readRDS(glue("../../Data/Simulation/Tabula_sapiens/Setting4/Simulation_setting4_seed_{n}_iteration{j}.rds"))
  ...
  dir.create(glue("../../Result/TS_Fs_marker/Traditional/Setting4"),showWarnings = FALSE)
  dir.create(glue("../../Result/TS_Fs_marker/Traditional/Setting4/{method}"),showWarnings = FALSE)
  saveRDS(res, file = glue("../../Result/TS_Fs_marker/Traditional/Setting4/{method}/Res_{method}_Simulation_setting4_seed_{n}_iteration{j}_all.rds"))
